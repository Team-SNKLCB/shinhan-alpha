<template>
    <div>
        ...
        <img @click="goBack" style="position: absolute; margin-top: 40px" src="../assets/X.png" />
        <img style="width: 320px; margin-top: 20px" src="../assets/mmf.png" />
        <div class="check_box">
            <span
                @click="
                    () => {
                        this.$router.push('/MMFbuy');
                    }
                "
