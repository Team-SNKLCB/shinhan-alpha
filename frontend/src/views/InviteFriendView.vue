<template>
    <div>
        <div v-if="friend_click === true" class="overlay">
            <div class="popup">
                <div class="back">
                    <font-awesome-icon icon="fa-solid fa-x" @click="friend_click = false" />
                </div>
                <br />

                <img style="width: 150px" src="../assets/invite_image.png" /><br />
                <p style="font-size: 20px; font-weight: bold">초대코드를 복사했어요!</p>
            </div>
        </div>
        <phone-header></phone-header>
        <div class="top-bar">
            <router-link to="tier_main"><font-awesome-icon style="font-size: 20px" icon="fa-solid fa-x" /></router-link>
        </div>
        ...
        <div class="code-div">
            ...
            <p style="color: #000000; font-weight: 600; font-size: 18px">010 9968 7216</p>
        </div>
        <p style="font-size: 9px; font-weight: 600; margin-top: 8px">초대코드는 가입 후 24시간 내까지 입력할 수 있어요</p>
        <div @click="friend_click = true" class="send-btn">친구에게 알리기</div>
    </div>
</template>
<script>
