  ...
  <div>
    ...
    <div class="alpha-menu-div">
      <div class="alpha-menu">
        ...
        >
          <p>주린이 모드</p>
          <p style="font-size: 10px; color: #8b8b8c">
            주식 입문자에게 투자가 조금 더 쉽게 다가올 수 있도록 할 수 있는
            주린이 모드가 활성화 됩니다.
          </p>
        ...
        <img
          v-if="save_toggle[0] === false"
          @click="changeToggle(0)"
          style="width: 70px; height: 35px; margin-left: 20px"
          src="../assets/off-btn.png"
        />
        <img
          v-else-if="save_toggle[0] === true"
          @click="changeToggle(0)"
          style="width: 70px; height: 35px; margin-left: 20px"
      ...
      <div class="alpha-menu">
        ...
        >
          <p>글자 크게 보기</p>
          <p style="font-size: 10px; color: #8b8b8c">
            모든 화면의 글자를 크게 볼 수 있습니다.
          </p>
        </div>
        <img
          v-if="save_toggle[1] === false"
          @click="changeToggle(1)"
          style="width: 70px; height: 35px; margin-left: 20px"
          src="../assets/off-btn.png"
        />
        <img
          v-else-if="save_toggle[1] === true"
          @click="changeToggle(1)"
          style="width: 70px; height: 35px; margin-left: 20px"
          src="../assets/on-btn.png"
        />
      ...
      <div class="alpha-menu">
        ...
        >
          <p>흔들기 기능</p>
          <p style="font-size: 10px; color: #8b8b8c">
            알파를 실행하고 휴대폰을 흔들면 설정한 흔들기 기능이 실행됩니다.
          </p>
        </div>
        <img
          v-if="save_toggle[2] === false"
          @click="changeToggle(2)"
          style="width: 70px; height: 35px; margin-left: 20px"
          src="../assets/off-btn.png"
        />
        <img
          v-else-if="save_toggle[2] === true"
          @click="changeToggle(2)"
          style="width: 70px; height: 35px; margin-left: 20px"
          src="../assets/on-btn.png"
        />
      ...
      <div class="alpha-menu">
        ...
        >
          <p>햅틱 기능</p>
          <p style="font-size: 10px; color: #8b8b8c">
            키패드와 증감버튼 터치시 햅틱 기능이 작동됩니다.
          </p>
        </div>
        <img
          v-if="save_toggle[3] === false"
          @click="changeToggle(3)"
          style="width: 70px; height: 35px; margin-left: 20px"
          src="../assets/off-btn.png"
        />
        <img
          v-else-if="save_toggle[3] === true"
          @click="changeToggle(3)"
          style="width: 70px; height: 35px; margin-left: 20px"
          src="../assets/on-btn.png"
        />
    ...
    <div style="display: flex; justify-content: space-around; margin-top: 10px">
      <router-link to="/menu_setting"
        ><div class="cancel-btn">취소</div></router-link
      >
      <router-link to="/easy_menu"
        ><div class="save-btn">저장</div></router-link
      >
